...
import ChickenPurchaseFormModal from "./ChickenPurchaseFormModal";

function ChickenPurchase() {
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", backgroundColor: "white", borderRadius: "8px", overflow: "hidden" }}>
              <thead>
                <tr style={{ backgroundColor: "#f8f9fa" }}>
                  ...
                  <th style={{ padding: "12px", textAlign: "left", borderBottom: "1px solid #dee2e6", fontWeight: "600" }}>Supplier Name</th>
                ...
                {filteredPurchases.length === 0 ? (
                  ...
                  filteredPurchases.map((purchase) => (
                    <tr key={purchase.id} style={{ borderBottom: "1px solid #f0f0f0" }}>
                      ...
                      <td style={{ padding: "12px", fontWeight: "600", color: "#ff9800" }}>{formatCurrency(purchase.totalCost || 0)}</td>
...
export default ChickenPurchase;
